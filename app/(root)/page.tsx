...
export default function IndexPage() {
  ...
  return (
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 pt-24 mb-0 md:pb-12 md:py-20 lg:py-24 flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          <Image
            ...
            alt="Ankit Sen - Full Stack Developer Portfolio"
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="mt-4 max-w-[42rem] text-center">
            <p className="leading-normal text-muted-foreground text-sm sm:text-base">
              I’m a Full Stack Developer passionate about crafting responsive, user-friendly digital solutions. Experienced in building and integrating systems that drive efficiency and enhance user engagement.
            </p>
          </div>
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            ...
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contact Ankit Sen"
              >
                <Icons.gmail className="w-4 h-4 mr-2" /> Contact
              </Link>
            </AnimatedText>
          </div>
      ...
      <AnimatedSection
        direction="right"
        className="container space-y-6 py-10 my-14 p-0"
        id="projects"
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          <AnimatedText
      ...
      <AnimatedSection
        direction="down"
        className="container space-y-6 bg-muted py-10 my-14 hidden"
        id="contributions"
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          <AnimatedText
